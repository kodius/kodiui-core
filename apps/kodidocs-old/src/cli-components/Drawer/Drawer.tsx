...
export const Drawer: FC<PropsWithChildren & DrawerProps> = (props) => {
  ...
  const { backdropAnimation, drawerSide, getAnimation, handleAnimationEnd, isDrawerStateClosed } =
  ...
  return (
    <Box position="fixed" width="screen" height="screen" zIndex="10" top="0" left="0">
      <FlexBox position="relative" zIndex="20" justifyContent={drawerSide} height="full">
        <Box
        ...
        >
          <Stack>
            <Header onClose={props.onClose} title={props.title} description={props.description} />
